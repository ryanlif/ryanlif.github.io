		...
		<section className="grid gap-12" id="about">
			<div className="flex justify-between">
				<div className="mr-8 hidden md:block rounded-md">
					...
					<span className="text-base mt-1 font-bold text-gray-700 dark:text-gray-100 hover:underline">Email:</span> <a href={`mailto:${personalInfo.about.email}`} className="text-base text-gray-700 dark: text-gray-300">{personalInfo.about.email}</a> 
