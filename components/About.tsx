		...
		<section className="grid gap-12" id="about">
			<div className="flex justify-between">
				<div className="mr-8 hidden md:block rounded-md">
					...
					<br/> <p className="text-base mt-4 font-bold text-gray-700 dark:text-gray-100 hover:underline">Phone: <span className="text-base text-gray-700 dark: text-gray-300">+1 (206)-321-8275</span></p>
				</div>
